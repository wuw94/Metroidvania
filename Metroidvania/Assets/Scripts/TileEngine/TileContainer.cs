...
public sealed class TileContainer : MonoBehaviour
{
	...
	{
		microtiles[0] = ((GameObject)Instantiate(Resources.Load("Prefabs/Immobiles/Tiles/MicroTile", typeof(GameObject)), transform.position + new Vector3(0.75f,0.75f,0), transform.rotation)).GetComponent<TileDisplay>();
		microtiles[0].rotation = 0;
		microtiles[0].transform.parent = transform;
		
		microtiles[1] = ((GameObject)Instantiate(Resources.Load("Prefabs/Immobiles/Tiles/MicroTile", typeof(GameObject)), transform.position + new Vector3(0.75f,0.25f,0), transform.rotation)).GetComponent<TileDisplay>();
		microtiles[1].rotation = 0;
		microtiles[1].transform.parent = transform;
		
		microtiles[2] = ((GameObject)Instantiate(Resources.Load("Prefabs/Immobiles/Tiles/MicroTile", typeof(GameObject)), transform.position + new Vector3(0.25f,0.25f,0), transform.rotation)).GetComponent<TileDisplay>();
		microtiles[2].rotation = 0;
		microtiles[2].transform.parent = transform;
		
		microtiles[3] = ((GameObject)Instantiate(Resources.Load("Prefabs/Immobiles/Tiles/MicroTile", typeof(GameObject)), transform.position + new Vector3(0.25f,0.75f,0), transform.rotation)).GetComponent<TileDisplay>();
